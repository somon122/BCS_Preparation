...
import com.world_tech_point.bcs_preparation.liveExamSection.RoutineActivity;
...
public class ArchiveActivity extends AppCompatActivity {
    ...
    private void updateListUsers(List<ArchiveClass> listQuestion) {
        ...
        ArchiveAdapter archiveAdapter = new ArchiveAdapter(ArchiveActivity.this, listQuestion);
